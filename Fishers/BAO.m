...
baoFisher[sigmaPerp_, sigmaPar_, nbar_, sigma8_, beta_, vol_, sigmaZ_:0.0] :=
    Module[ {sperp2, spar2, sz2, mustep, nP, mu2List, mutmp, sumList, matList},
        sperp2 = sigmaPerp^2;
        spar2 = sigmaPar^2;
        sz2 = sigmaZ^2;
        mustep = If[ Sqrt[spar2 + sz2] > 3*sigmaPerp,
                     mustep0/10.0,
                     mustep0
                 ];
